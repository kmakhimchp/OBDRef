...
- [ ] A dedicated branch was created from the application branch using the convention: `<ProjectName>_module_<JIRAID>`
- [ ] All implementation was done on the milestone branch (no direct commits to the application branch or the default branch)
...
- [ ] CLAUDE.md Active Milestone was pointing to this milestone (with JIRA ID and branch name) during implementation
...
- [ ] All work was done on the milestone branch (`<ProjectName>_module_<JIRAID>`), not on the application branch or the default branch
...
- [ ] Branch is ready to merge into the application branch (no conflicts, builds on branch match application branch baseline)
...
- [ ] JIRA ticket will be updated to Done after merge to the application branch
...
| **Branch**             | `_ProjectName_module_JIRAID_`                           |
